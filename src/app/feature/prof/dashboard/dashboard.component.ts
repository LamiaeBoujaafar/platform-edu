...
export class DashboardComponent implements OnInit {
  ...
  startAnimationForBarChart(chart: { on: (arg0: string, arg1: (data: { type: string; element: { animate: (arg0: { opacity: { begin: number; dur: any; from: number; to: number; easing: string; }; }) => void; }; }) => void) => void; }){
